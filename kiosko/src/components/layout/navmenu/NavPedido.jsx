    ...
    <div className="dropdown dropdown-end">
      <label tabIndex={1} className="btn btn-ghost btn-circle">
        <div className="indicator">
          <FaShippingFast className="h-5 w-5"></FaShippingFast>
          {cantida !== 0 && (
      ...
      <div
        tabIndex={1}
        className="mt-3 card card-compact dropdown-content w-52 -left-20 md:left-auto bg-base-100 shadow"
      >
        <div className="card-body">
          <span className="font-bold text-lg">
            {cantida} {cantida > 1 ? "pedidos" : "pedido"}{" "}
          </span>
