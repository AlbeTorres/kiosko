    ...
    <div className="dropdown dropdown-end">
      ...
      >
        <div className="card-body">
          <div
            onClick={() => history("/adminpedido")}
            className=" flex items-center  justify-start my-1 cursor-pointer hover:bg-slate-100 p-2 rounded-md "
          >
            <span className="font-bold text-lg">
              {pedidos > 1 ? "nuevos pedidos" : "nuevo pedido"}{" "}
            </span>
