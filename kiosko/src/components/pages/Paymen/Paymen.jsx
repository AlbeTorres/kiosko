  ...
  return (
    <div>
      ...
      <div className="grid  place-items-center gap-y-4 ">
        <div className="card w-11/12 bg-base-100 shadow-xl image-full">
          ...
          <div className="card-body">
            ...
            <p>Pague desde la comodidad de su móvil y priorice su envío</p>
      ...
      <div className="w-11/12 mx-auto mt-5">
        <button className="btn btn-primary w-full my-2">Crear pedido</button>
        <button className="btn w-full mb-2">Cancelar</button>
      </div>
    </div>
  );
};
